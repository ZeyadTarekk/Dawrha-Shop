...
include "init.php";
        ...
        $_SESSION['priceValue']=strtok($_SESSION['price'],  '.');
        if($_SESSION['priceValue']==0){
          $_SESSION['priceValue']=$_SESSION['price'];
        }
        $_SESSION['decimal']=floatVal($_SESSION['price']-$_SESSION['priceValue']);
