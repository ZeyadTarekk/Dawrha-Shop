  ...
  <div class="col-md-10 row justify-content-center m-5 text-center shadow">
    <div class="col-lg-5 col-md-12">
      <form class="form-signin p-5">
        ...
        <p class="mb-4 text-secondary">By clicking Sign In, you agree to our <a href="#" class="link-primary">Terms
            of
            Use</a> and our <a href="#" class="link-primary">Privacy Policy</a>.</p>
        <div class="d-grid gap-2">
          <input type="submit" class="btn btn-block btn-success text-white rounded-pill btn-lg" value="Sign-in">
        </div>
        <span class="d-block text-left my-4 text-muted">— or signup —</span>
        <button type="button"
          class="btn btn-block btn-success text-white rounded-pill btn-lg ps-5 pe-5">Sign-up</button>
      </form>
    </div>
