...
<div class=" row justify-content-evenly container-fluid ">
    <div class=" col-md-10 row justify-content-center m-5 text-center shadow">
            ...
            <div class="special">
                ...
                <div class="center">
                    <div class="buttons d-flex flex-row">
                        ...
                        <button class="btn btn-success cart-button px-5" style="font-weight: 400;">
        ...
        <div class="col-lg-7 col-md-12">
            <img src=" layout/images/item.jpg" alt="image item" class="img-fluid" style="width:50%; margin:100px;">
        </div>
    </div>
</div>
